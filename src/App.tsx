            ...
            <main className="flex-1">
              <header className="h-14 flex items-center border-b bg-card px-4">
                ...
                <div className="flex-1">
                  <h1 className="text-lg font-semibold text-foreground">Railway Fault Management System</h1>
                </div>
              </header>
              <div className="flex-1">
                <Routes>
                  ...
                  {/* FOR KUNAL , PARAS AND BACKEND TEAM, ADD ALL CUSTOM ROUTES ABOVE THE CATCH-ALL "*" ROUTE */}
